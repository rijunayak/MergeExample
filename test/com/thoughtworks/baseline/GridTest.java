...
public class GridTest {
    ...
    @Test
    public void shouldReturnAliveCellForAnAliveCellWithAnAliveCellToItsLeftAndToItsDiagnolSouthLeftOnly() {
        Cell cell1 = mock(Cell.class);
        Cell cell2 = mock(Cell.class);
        Cell cell3 = mock(Cell.class);
        Cell cell4 = mock(Cell.class);
        ...
        when(cell5.stateOfCell()).thenReturn(true);
        when(cell6.stateOfCell()).thenReturn(false);
        when(cell7.stateOfCell()).thenReturn(true);
        when(cell8.stateOfCell()).thenReturn(false);
        when(cell9.stateOfCell()).thenReturn(false);
    ...
    @Test
    public void shouldReturnAliveCellForAnAliveCellWithAnAliveCellToItsLeftAndToItsDiagnolSouthRightOnly() {
        Cell cell1 = mock(Cell.class);
        Cell cell2 = mock(Cell.class);
        Cell cell3 = mock(Cell.class);
        Cell cell4 = mock(Cell.class);
    ...
    @Test
    public void shouldReturnAliveCellForAnAliveCellWithThreeAliveNeighbours() {
        Cell cell1 = mock(Cell.class);
        Cell cell2 = mock(Cell.class);
        Cell cell3 = mock(Cell.class);
        Cell cell4 = mock(Cell.class);
    ...
    @Test
    public void shouldNotReturnAnAliveStateForADeadCellWithOnlyTwoAliveNeighbours() {
        Cell cell1 = mock(Cell.class);
        Cell cell2 = mock(Cell.class);
        Cell cell3 = mock(Cell.class);
        Cell cell4 = mock(Cell.class);
    ...
    @Test
    public void shouldReturnAnAliveStateForADeadCellWithExactlyThreeAliveNeighbours() {
        Cell cell1 = mock(Cell.class);
        Cell cell2 = mock(Cell.class);
        Cell cell3 = mock(Cell.class);
        Cell cell4 = mock(Cell.class);
